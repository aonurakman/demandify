...
ASCII_ART = r"""
  ____  _____ __  __    _    _   _ ____  ___ _______   __
 |  _ \| ____|  \/  |  / \  | \ | |  _ \|_ _|  ___\ \ / /
 | | | |  _| | |\/| | / _ \ |  \| | | | || || |_   \ V / 
 | |_| | |___| |  | |/ ___ \| |\  | |_| || ||  _|   | |  
 |____/|_____|_|  |_/_/   \_\_| \_|____/|___|_|     |_|  
      Traffic Demand Calibration for SUMO
"""
...
def cmd_run(args):
    ...
    print(f"   GA: pop={args.pop}, gen={args.gen}")
    print("-" * 50)
    ...
    try:
        ...
        run_id = run_dir_name.replace('run_', '')
        ...
        print("║" + " "*58 + "║")
        print("╚" + "═"*58 + "╝")
        print(f"\n📄 Report available at: {result['report_file']}\n")
        
    except Exception as e:
        if "No traffic sensors matches" in str(e):
            print("\n⚠️  WARNING: No traffic sensors in this area.")
            print("   Cannot calibrate demand without ground truth data.")
            print("   Try a larger bounding box or a more urban area.")
            return
